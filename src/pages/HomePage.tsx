    ...
    <>
      ...
      <div className="grid mt-36 place-items-center">
        <div className="grid place-items-center">
          <h1 className="font-bold text-6xl text-black dark:text-white mb-10 ">COMMUNITY ZK-ACTIVITY TRACKER</h1>
          <p className="text-black dark:text-white font-light text-2xl text-center mr-4 ml-4 max-w-4xl">
            Blocklab-protocol's zk-track-activity is a website where you can track your address and see how many volume you did on different zkSync
            protocols.
          </p>
